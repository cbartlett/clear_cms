class ClearCMS::SitesController < ApplicationController
  ...
  def create
    @clear_cms_site = ClearCMS::Site.new(params[:clear_cms_site])
  ...
  def update
    ...
    respond_to do |format|
      if @clear_cms_site.update_attributes(params[:clear_cms_site])
